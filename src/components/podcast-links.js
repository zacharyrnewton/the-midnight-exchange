...
const PodcastLinks = ({ siteTitle }) => (
  <div class="podcast-links">
    <a href="https://google.com" target="_blank" rel="noopener noreferrer" class="icon-link">Apple Podcast
    ...
    <a href="https://google.com" target="_blank" rel="noopener noreferrer" class="icon-link">Google Podcast
    ...
    <a href="https://google.com" target="_blank" rel="noopener noreferrer" class="icon-link">Spotify Podcast
    ...
    <a href="https://google.com" target="_blank" rel="noopener noreferrer" class="icon-link">RSS Feed

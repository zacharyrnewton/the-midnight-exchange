...
const PodcastLinks = ({ siteTitle }) => (
  <div className="podcast-links">
    <a href="https://podcasts.apple.com/us/podcast/the-midnight-exchange/id1500209456" target="_blank" rel="noopener noreferrer" className="icon-link"
      onClick={e => {
        // e.preventDefault()
        trackCustomEvent({
    ...
    <a href="https://podcasts.google.com/?feed=aHR0cHM6Ly90aGVtaWRuaWdodGV4Y2hhbmdlLmNvbS9wb2RjYXN0LnhtbA" target="_blank" rel="noopener noreferrer" className="icon-link"
      onClick={e => {
        // e.preventDefault()
        trackCustomEvent({
          category: "Podcast Links",
          action: "Podcast Link Click",
          label: "Google Podcast URL",
          // value: 43
        })
      }}
    >Google Podcast
    ...
    <a href="https://open.spotify.com/show/6rMXC0PcPvRSi3r8ULqVjI?si=V7fltxHfQ2mr6YZsCTpiCw" target="_blank" rel="noopener noreferrer" className="icon-link"
      onClick={e => {
        // e.preventDefault()
        trackCustomEvent({
          category: "Podcast Links",
    ...
    <a href="/podcast.xml" className="icon-link" rel="alternate" type="application/rss+xml"
      onClick={e => {
        // e.preventDefault()
        trackCustomEvent({
          category: "Podcast Links",

...
const PodcastLinks = ({ siteTitle }) => (
  <div className="podcast-links">
    ...
    <a href="https://open.spotify.com/show/6rMXC0PcPvRSi3r8ULqVjI?si=V7fltxHfQ2mr6YZsCTpiCw" target="_blank" rel="noopener noreferrer" className="icon-link">Spotify Podcast
